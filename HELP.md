...
* The original package name 'it.gov.pagopa.rtd-ms-payment-instrument' is invalid and this project uses 'it.gov.pagopa.rtdmspaymentinstrument' instead.
...
```
$ docker run --rm -p 8080:8080 rtd-ms-payment-instrument:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/rtd-ms-payment-instrument
```
